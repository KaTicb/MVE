...
int main(int argc, char **argv, char *env[])
{
    ...
    constexpr double alf_1 = -h / r;
    constexpr double alf_2 = -r / h;
    constexpr double alf_3 = alf_2 * 0.5f;
    constexpr double alf_4 = alf_1 * 0.5f;
    constexpr double gam_1 = -2.f * (alf_1 + alf_2);
    constexpr double gam_2 = -1.5f * (alf_1 + alf_2);
    constexpr double gam_3 = -(alf_1 + alf_2);
    constexpr double gam_4 = -(alf_3 + alf_4);
        ...
        for (std::size_t j = 0; j <= j3; ++j)
        {
            for (std::size_t i = 0; i <= i3; ++i)
            {
                ...
                if (i > 0 && i < i3 && j > 0 && j < j1)
                {
                    T[j][i] =
                        T[j][i] -
                        beta_1 * (alf_1 * T[j - 1][i] + alf_2 * T[j][i - 1] +
                ...
                else if (i > i1 && i < i3 && j == 0)
                {
                    T[j][i] =
                        T[j][i] -
                        beta_3 * (alf_3 * T[j][i - 1] + alf_3 * T[j][i + 1] +
                ...
                else if (j > j1 && j < j3 && i == 0)
                {
                    T[j][i] =
                        T[j][i] -
                        beta_3 * (alf_4 * T[j - 1][i] + alf_2 * T[j][i + 1] +
                ...
                else if (i == i1 && j == j1)
                {
                    T[j][i] =
                        T[j][i] -
                        beta_2 * (alf_1 * T[j - 1][i] + alf_2 * T[j][i - 1] +
                ...
                else if (i == i2 && j == j1)
                {
                    T[j][i] =
                        T[j][i] -
                        beta_2 * (alf_1 * T[j - 1][i] + alf_3 * T[j][i - 1] +
